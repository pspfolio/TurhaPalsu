...
/***/ function(module, exports) {
	...
	// removed by extract-text-webpack-plugin
	module.exports = {"container":"settings__container___NAzMo","item":"settings__item___ekEL7"};
	...
	var Controls = function (_Component) {
	  ...
	  _createClass(Controls, [{
	    ...
	    value: function render() {
	      return (0, _preact.h)(
	        'div',
	        { className: _controls2.default.settings },
	        (0, _preact.h)(
	          'div',
	          { className: _controls2.default.item },
	          this.props.runningSince ? (0, _preact.h)('img', { onClick: this.handlePlayClick, 'class': _controls2.default.btn, src: './images/pause.svg', alt: 'pause' }) : (0, _preact.h)('img', { onClick: this.handlePlayClick, 'class': _controls2.default.btn, src: './images/play.svg', alt: 'play' })
	        ),
	        (0, _preact.h)(
	          'div',
	          { className: _controls2.default.item },
	          (0, _preact.h)('img', { className: _controls2.default.item, onClick: this.handleRestartClick, 'class': _controls2.default.btn, src: './images/restart.svg', alt: 'play' })
	        )
	      );
	    }
	  }]);
