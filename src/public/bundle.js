...
/***/ function(module, exports, __webpack_require__) {
	...
	var Dashboard = function (_Component) {
	  ...
	  function Dashboard() {
	    ...
	    _this.handlePersonsAdded = _this.handlePersonsAdded.bind(_this);
	    _this.handleSalaryAdded = _this.handleSalaryAdded.bind(_this);
	    return _this;
	  }
	  ...
	  _createClass(Dashboard, [{
	    ...
	    */
	    ...
	    key: 'handlePersonsAdded',
	    value: function handlePersonsAdded(num) {
	      this.setState({ persons: num });
	    }
	  }, {
	    key: 'handleSalaryAdded',
	    value: function handleSalaryAdded(salary) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	  return (0, _preact.h)(
	    'header',
	    { className: _header2.default.bgColor },
	    (0, _preact.h)(
	      'h1',
